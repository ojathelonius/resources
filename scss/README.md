...
* [Color any element using CSS](#color-any-element-using-css)
...
### Color any element using CSS

CSS `filter` property generator, taken from CodePen, saved in case it goes down : https://codepen.io/sosuke/pen/Pjoqqp
